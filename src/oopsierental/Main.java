...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 1. Create Branch
        Branch mainBranch = new Branch("BR-35", "Izmir Center", "Izmir");
        ...
        // 4. Create Customer
        Customer customer1 = new Customer("CST-01", "Murat", "Yildiz", "murat@yildiz.com", "123");
        ...
        System.out.println(
                "Action: Vehicle Rented -> " + car1.getBrand() + " for " + rentalDays + " days with Full Coverage.");
